...
export default function Footer() {
  return (
    <div>
      <footer class="text-gray-400 bg-gray-50 body-font">
  <div class="container px-3 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <img className='h-14' src="/logo.png" alt="logo" />
      {/* <span class="ml-3 text-xl text-gray-400">Aligarh.com</span> */}
    </a>
    <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2023 Aligarh —
      <a href="https://twitter.com/knyttneve" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@aligarh</a>
    </p>
